...
('batch_size', 240),  # Kích thước batch trong quá trình huấn luyện
('dropout_p_embed', 0.45),  # Xác suất dropout cho embedding
('dropout_p_hidden', 0.0),  # Xác suất dropout cho các lớp ẩn
('learning_rate', 0.065),  # Tốc độ học (learning rate)
